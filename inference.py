...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_preds', action='store_true',
                        help='whether to save predictions in run-length encoding format')
    ...
    parser.add_argument('--name_pict', type=str, default='True vs predicted masks',
                        help='file name where to save the results of inferencing')
    ...
    gen = CustomDataGen(y_group, args.path_infer, args.num_pict, use_bool=False, resize=True, height=args.img_height,
                        width=args.img_width)
    gen.im_list = gen.im_list[args.start_sample:]

    # comparing true masks vs predicted masks
    images, masks = gen[0]
    preds = plot_preds(images, masks, unet, start_sample=args.start_sample, num_pict=args.num_pict,
